#!/bin/bash
#SBATCH --job-name=nf_tlg1025_v7
#SBATCH --output=/hpc/projects/mass_spec_chi/Team/Tony/msdial-tlg1025/logs/nf_tlg1025_v7_%j.out
#SBATCH --error=/hpc/projects/mass_spec_chi/Team/Tony/msdial-tlg1025/logs/nf_tlg1025_v7_%j.err
#SBATCH -p cpu
...
OUTDIR="/hpc/projects/mass_spec_chi/Team/Tony/msdial-tlg1025/v7_containerized"
LIBS_DIR="/hpc/projects/mass_spec_chi/Team/Tony/metabolomics_libraries"

echo "============================================"
echo "Nextflow MS-DIAL TLG1025 v7 (containerized)"
echo "============================================"
echo "Node:      $(hostname)"
echo "Started:   $(date)"
